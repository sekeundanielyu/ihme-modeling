** Description: HIV-TB prevalence calculation
...
save /ihme/gbd/WORK/04_epi/01_database/02_data/tb/temp/HIVTB_prev_cyas_`custom_version'_capped.dta, replace
...
/*	
    ...
    save_results, modelable_entity_id(1176) description(`acause' `custom_version') mark_best(yes) in_dir(/ihme/gbd/WORK/04_epi/01_database/02_data/`acause'/temp/draws/`custom_version') metrics(prevalence)
