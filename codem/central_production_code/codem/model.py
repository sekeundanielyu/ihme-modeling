'''
This is gonna be the heart and soul of model prediction,
validation, storing information and making draws. At the very least a model
should be able to take in a variance covariance matrix of betas, the mean of
those betas and a list of random effects and use those to make predictions.
'''
