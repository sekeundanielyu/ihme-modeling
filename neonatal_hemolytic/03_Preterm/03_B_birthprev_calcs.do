...
local in_dir "`working_dir'/01_prep/neonatal_hemolytic/03_preterm/preterm_aggregate_birth_prevalence.csv"
local out_dir "`working_dir'/02_analysis/neonatal_hemolytic/03_preterm"
...
//log
capture log close
log using "`log_dir'/hemo_03_B_preterm_kern_prev_`timestamp'.smcl", replace
...
///////////////////////////////////////////////////////////// */
	...
	//2. bring in prevalence data 
		...
		keep ihme_loc_id location_id year sex draw*
...
//5. Save ehb and kern, get summary stats
	...
	foreach disease_type in ehb kernicterus{
		di "all draws"
		preserve
			keep year sex location_id ihme_loc_id `disease_type'_draw*
...
///////////////////////////////////////////////////////////// */
	...
	if `plot_prev'==1{
		...
		use "`out_dir'/preterm_kernicterus_summary_stats.dta", clear
		
		//for ylabeling 
		qui sum mean
		local max_val = r(max)

		pdfstart using "`plot_dir'/preterm_kernicterus_time_series.pdf"
