...
////////////////////////////////////////////// */ 
	...
	// load functions 
	run "J:\WORK\10_gbd\00_library\functions\get_covariate_estimates.ado"
	...
	local out_dir "`working_dir'/01_C_birth_order"
...
// Create timestamp for logs2
	...
	//log
	capture log close
	log using "`log_dir'/01_C_birth_order_`timestamp'.smcl", replace
...
///////////////////////////////////////////////////////////// */
	...
	import excel using `=word(`"`files'"', wordcount(`"`files'"'))', firstrow clear
		...
		// Get covariates and randome effects set up:
	...
	if `plot_props'==1{
		...
		use "`out_dir'/notfirst_birth_prev_summary_stats.dta", clear
		...
		pdfstart using "`plot_dir'/notfirst_birth_prev_time_series.pdf"
