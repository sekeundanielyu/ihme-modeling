...
******************************************************************************/
	...
	// directories 
		...
		local in_dir "`working_dir'/01_prep/neonatal_hemolytic/02_g6pd"
		local out_dir "`working_dir'/02_analysis/neonatal_hemolytic/02_g6pd"
	...
	// Create timestamp for logs
		...
		//log
		capture log close
		log using "`log_dir'/hemo_02_B_g6pd_kern_prev_`timestamp'.smcl", replace
...
///////////////////////////////////////////////////////////// */
	...
	if `plot_prev'==1{
		...
		use "`out_dir'/g6pd_kernicterus_summary_stats.dta", clear
		...
		pdfstart using "`plot_dir'/g6pd_kernicterus_time_series.pdf"
