...
UPDATED 27 Feb 2014 to rank no-long-term N-codes via short-term DW
"""
...
def main(hierarchy_path,py_modules_parent,out_dir):
    ...
    empirical = pd.read_csv(join(hierarchy_path,'empirical_hierarchy.csv'))
    ...
    writer = pd.ExcelWriter(join(out_dir,'hierarchies.xls'))
