...
// Define filepaths
	local in_dir "`prefix'/WORK/04_epi/01_database/02_data/_inj/archive_2013/04_models/gbd2013/02_inputs"
...
// Save final file
	rename ncode n_code
	keep n_code draw*
	export delimited using "`out_dir'/`category'_dws_by_ncode.csv", replace delim(",")
