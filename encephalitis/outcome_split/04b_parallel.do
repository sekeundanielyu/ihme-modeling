		...
		foreach sex of local sexes {
			...
			** Pull in the outcome file
			...
			if "`group'" == "_vision" { 
				...
				outsheet using "`tmp_dir'/03_outputs/01_draws/`group'/_unsqueezed/5_`location'_`year'_`sex'.csv", comma replace 
			}
			else {
