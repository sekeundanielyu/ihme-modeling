odbc load, exec("SELECT age_group_id, name, alt_name as age_name, age_start, age_end FROM age_groups") dsn(epi) clear
...
save J:/WORK/04_epi/02_models/01_code/06_custom/hepatitis/inputs/hepB_chronic2acute.dta, replace
