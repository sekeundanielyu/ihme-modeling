...
levelsof location_id if income=="Low", local(low)
...
gen row_num = ""
generate modelable_entity_id = 3075
gen modelable_entity_name = "Rheumatic heart disease - Low income"
gen nid = 259601
...
export excel using "strPath/me_3075_csmr_28Jun2016.xlsx", replace sheet("extraction") firstrow(variables)
