...
//Start log
capture log close
log using strPath/logs/meps_prep, replace

// Set the Locals
local icd_maps "strPath"
local meps_folder "strPath"
...
// Use survey settings and the weights to generate weighted proportions of prevalence
...
// Get overall prevalence of HF due to cvd_other
