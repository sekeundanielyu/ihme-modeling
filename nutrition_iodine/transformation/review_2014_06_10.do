...
// prep stata (shouldn't need to modify except to increase memory)
	...
	/* run "$prefix/WORK/04_epi/01_database/01_code/03_data/01_transform/ess_split.ado" */
	run "$prefix/WORK/04_epi/01_database/02_data/${functional}/03_review/01_code/agesex_split.ado"  
...
// run transformations, organized by logical groupings
	...
	// age-sex split data points given by age and by sex separately (example given below)
		...
		gen agesex_split_group = 1 if nid==43563 & iso3=="ARE" & data_status==""
