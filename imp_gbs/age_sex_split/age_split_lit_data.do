...
clear all
	...
	run "$prefix/WORK/10_gbd/00_library/functions/get_outputs_helpers/query_table.ado"
...
* get_data, modelable_entity_id(2404) clear 
	import excel "$prefix/WORK/04_epi/01_database/02_data/imp_gbs/2404/03_review/01_download/me_2404_ts_2016_05_13__122350.xlsx", firstrow clear 
	tempfile data
	save `data', replace
...
preserve
drop if split == 1
export excel "$prefix/WORK/04_epi/01_database\02_data\imp_gbs\2404\03_review\03_upload/age_split_parents.xlsx", firstrow(var) sheet("extraction") replace 
restore

//Save children 
keep if split == 1 
drop age_span n split 
export excel "$prefix/WORK/04_epi/01_database\02_data\imp_gbs\2404\03_review\03_upload/age_split_children.xlsx", firstrow(var) sheet("extraction") replace 
