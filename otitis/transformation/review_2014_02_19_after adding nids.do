...
// prep stata (shouldn't need to modify except to increase memory)
	...
	run "$prefix/WORK/04_epi/01_database/01_code/03_data/01_transform/agesex_split.ado" */
...
// download and load lit data (this will grab the latest changes made to the database including marking outliers)
	...
	insheet using "$prefix/WORK/04_epi/01_database/02_data/otitis/03_review/03_temp/otitis_2014_02_19_nid added.csv", comma clear
