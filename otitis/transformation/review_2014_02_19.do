...
replace citation="Kamal N et al. Prevalence of chronic suppurative otitis media among the children living in two selected slums of Dhaka City. Bangladesh Med. Res. Counc. Bull. 2004;30:95-104" if row_id==10 & grouping=="chronic" & description=="GBD 2010 All uncertfix"
...
// run transformations, organized by logical groupings
	...
	// split denominators by age/sex distribution observed in the general population for each given country/year (example given below)
		...
		esssplit ${functional}, date(${date}) tmpdir("`out_dir'/03_temp/${date}")
