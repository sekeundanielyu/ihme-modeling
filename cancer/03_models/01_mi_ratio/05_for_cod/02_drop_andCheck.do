...
** *****************************************************************************	
** NOTE: Data from the CI5 appendix (source = "CI5_Appendix_1966_2002") was used in GBD 2010 for lack of sufficient data. This data should be removed whenever possible
...
// Drop if all entries are missing. Drop exceptions
	drop cases1
