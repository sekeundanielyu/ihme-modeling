...
** **************************************************************************	
	// main directory
		local data_dir "$prefix/WORK/07_registry/cancer/02_database/03_sequela_duration/data"
...
// Add a row for mesothelioma (5 year death deadline)
	count
	local newobs= `r(N)'+1
	set obs `newobs'
