...
// Purpose:	Handldels special formatting during the creation of cancer maps 
...
// standardize ICD10 causes
	...
	local standardize_causes = "$registry_intake_code/01_standardize/subroutines/standardize_causes.do"
...
** **************************************************************************
** Drop unnecessary data and save
** **************************************************************************		
** use `causes_standardized', clear

// Rename variables and drop unnecessary variables 
	// drop subtotals (data should have been checked against the subtotals to ensure that no data was dropped by the source)
...
// Drop remaining duplicates
	...
	// drop remaining duplicates within mohsen_map
