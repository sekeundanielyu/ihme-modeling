...
** **************************************************************************				
	local survival_dir "$j/WORK/07_registry/cancer/02_database/02_survival"
...
if `SEER_yearly' {
	// Import headers, format and tempfile
		insheet using "`survival_dir'/data/raw/USA_1970_2010_yearly_survival_by_cause_headers.csv", clear
	...
	// Import yearly data, format, merge with headers and save
		...
		// map with gbd causes
			preserve
			insheet using "`survival_dir'/maps/seer_survival_gbd_cause_map.csv", clear
		...
		// save
			saveold "`survival_dir'/data/intermediate/seer_yearly_1_30_years.dta", replace
			tempfile best
			save `best', replace
}		
...
// /////////////////////////////////////////////////////
if `SEER_5_year' {
	// Import 1950 data, map with causes, format and tempfile
...
if `GBD2015_update'{
	// Import data
		import delimited using "`survival_dir'/data/raw/Leukemia_Gallbladder_mesothelioma.csv", clear
