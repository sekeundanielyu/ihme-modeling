...
class SuperGopher(object):
    ...
    def content(self, skip_refresh=False, **kwargs):
        ...
        Args:
            skip_refresh (bool): If true, the list of files present in the
                directory will not be refreshed before retrieving content.
                Defaults to False.
