...
// bring in the UCDP database 
	import excel "UCDP_PRIO_BATTLE_DEATHS_DATASET_V3.0_1946_2008_SUB_strUser.xlsx", clear firstrow
...
// drop data after 1988
	...
	** replace conflicts with -999 deaths with average of bdeadlow bdeadhig
	...
	// limit dataset to indicator countries
	 ...
	 // save dataset
		saveold "Battles_1950-1989_deaths_split.dta", replace
