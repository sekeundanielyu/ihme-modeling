...
* BOILERPLATE *
  ...
  capture log close
  log using /home/j/WORK/04_epi/02_models/01_code/06_custom/trachoma/logs/impairment.txt, replace

  
* PULL IN DATA *   
  use  /home/j/WORK/04_epi/02_models/01_code/06_custom/trachoma/inputs/modellingData.dta, clear
...
* PREP DRAWS FOR EXPORT *  
  ...
  capture mkdir /ihme/scratch/users/strUser/trachoma/impairment

  outsheet using /ihme/scratch/users/strUser/trachoma/impairment/full.csv, comma replace


* SAVE RESULTS * 
  capture rm /ihme/scratch/users/strUser/trachoma/impairment/all_draws.h5
  run /home/j/WORK/10_gbd/00_library/functions/save_results.do 
  save_results, modelable_entity_id(1500) description("Proportion of low vision due to trachoma (custom mixed effects)") in_dir("/ihme/scratch/users/strUser/trachoma/impairment")  file_pattern(full.csv) mark_best(yes)
