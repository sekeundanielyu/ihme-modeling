...
** **********************
	...
	global ddm_file = "strPath/d05_formatted_ddm.dta"
	global child_file = "strPath/d06_child_completeness.dta"
	global save_file = "strPath/d07_child_and_adult_completeness.dta"
...
** Recombine sources that were DDMd separately 
	...
	replace source_type = "VR" if regexm(source_type, "VR")==1 & !inlist(source_type,"VR-SSA","VR_pre2002","VR_post2002","IRN_VR_pre2003","IRN_VR_post2003","VR1","VR2") & !inlist(source_type,"MEX_pre2011","MEX_post2011") 
...
** Resplit Turkey (the change in 2009 is abrupt, and we don't want to try and fit a curve to that change) 
...
** resplit South Korea
	...
	replace source_type = "VR2" if ihme_loc_id == "KOR" & source_type == "VR" & year > 1977
...
** resplit child Iran VR
    replace source_type = "IRN_VR_pre2003" if ihme_loc_id == "IRN" & source_type == "VR" & year <= 2003
    replace source_type = "IRN_VR_post2003" if ihme_loc_id == "IRN" & source_type == "VR" & year > 2003
