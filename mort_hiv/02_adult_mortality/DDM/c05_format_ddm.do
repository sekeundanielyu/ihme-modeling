...
** **********************
	...
	global ddm_file "strPath/d04_raw_ddm.dta"
	global save_file "strPath/d05_formatted_ddm.dta"
...
** That means that it doesn't necessarily choose the optimal validated age trim if the age groups are different, in which it chooses one close to optimal
