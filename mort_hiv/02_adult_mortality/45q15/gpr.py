...
def gpmodel(prior_mort, prior_year, data_mort, data_year, data_stderr, data_category, scale, amp2, cc):
    ...
    allyear = pl.array(list(data_year[data_category == 'complete']) + list(data_year[(data_category == 'ddm_adjust') | (data_category == 'gb_adjust')]) + list(data_year[data_category == 'sibs']) + list(data_year[data_category == 'no_adjust']))
    allvar = pl.array(list(data_stderr[data_category == 'complete']) + list(data_stderr[(data_category == 'ddm_adjust') | (data_category == 'gb_adjust')]) + list(data_stderr[data_category == 'sibs']) + list(data_stderr[data_category == 'no_adjust']))**2
