...
# rr = "Central_Sub-Saharan_Africa"
# cc = "GNQ"

# rr = 'Western_Europe'
# cc = 'GBR'

#rr = "North_Africa_and_Middle_East"
#cc = "SAU_44544"
...
os.chdir('%s/WORK/02_mortality/03_models/2_5q0/results/' % ('/home/j' if os.name=='posix' else 'J:'))
data = pl.csv2rec('selected_parameters.txt', missing='NA')

#Chris wants scale changed for SLE to be bigger (it's 10 now) 11/1/13
#SLE is in Western_Sub-Saharan_Africa
