...
## append function to combine datasets
...
# ----------------------------------------------------------------------------
  ...
  iso3.data<-"tm country to iso3.csv"                            # ISO 3 to Country name file
  tm.data<-"EST_tm_VARIOUS_v5Q0 12-21-09.dta"               

#----------------------------------------------------------
#Summary birth history datasets

  random.sbh<-"EST_RANDOM_v5Q0_IHME.dta"                      # OTHER SOURCES: MOSTLY FROM UN POP DIVISION
  ...
  tlsdhs.sbh<-"EST_TLS DHS_v5Q0_IHME.dta"					            # subset of IDN DHS for Timor Leste back in time; also 2003 TLS DHS
  ...
  irndhs.sbh<-"EST_IRN_DHS_2000_v5Q0_IHME.dta"		            # IRN 2000 DHS
  ...
  ihds.0405.sbh <- "EST_IND_human_development_survey_04_05_v5Q0_IHME.dta" #IND Human Development Survey 04-05 microdata
  ...
  rwa.eicv.sbh <- "EST_RWA_EICV_2006_v5Q0_IHME.dta"             #RWA EICV 06 
  ...
  jor.1988.child.mort.survey.sbh <- "EST_jor_1988_child_mort_survey_v5Q0_IHME.dta"  # Jordan 1988 Child mortality survey
  jor.1990.child.mort.survey.sbh <- "EST_jor_1990_child_mort_survey_v5Q0_IHME.dta"  # Jordan 1990 Child mortality survey
  khm.socioec.survy.1997.sbh <- "EST_khm_socioeconomic_survey_1997_v5Q0_IHME.dta"  # Cambodia 1997 Socioeconomic Survey
  khm.socioec.survy.1999.sbh <- "EST_khm_socioeconomic_survey_1999_v5Q0_IHME.dta"  # Cambodia 1999 Socioeconomic Survey                                                                                                           
  nga.general.hh.surv.sbh <- "EST_nga_general_hh_survey_v5Q0_IHME.dta"             # Nigera General Household Survey 2006
  mng.rhs.1998.report.sbh <- "EST_MNG_RHS_1998_REPORT_v5Q0_IHME.dta"     # Mongolia RHS 1998 Report
  mkd.mics.2011.report.sbh <- "EST_MKD_MICS_2011_report_v5Q0_IHME.dta"   # Macedonia MICS 2011 report SBH
  ...
  hnd.living.conditions.2004.sbh <- "EST_HND_SURVEY_OF_LIVING_CONDITIONS_2004_v5Q0_IHME.dta"  # Honduras Survey of Living Conditions 2004
  ...
  cod.mics1995.data.sbh <- "EST_COD MICS 1995_v5Q0_IHME.dta"                         # COD mics 1995 sbh 
  ...
  zaf.oct.hh.survey.subnat.sbh <- "EST_ZAF_OCT_HH_SURVEY_subnat_v5Q0_IHME.dta" 		# South Africa October Household Survey Subnational SBH 1993, 1994, 1995, 1997, 1998
  ...
  plw.census2000.sbh <- "EST_PLW_CENSUS_2000_REPORT_v5Q0_IHME.dta" 	#Palau 2000 Census report SBH
  plw.census1995.sbh <- "EST_PLW_CENSUS_1995_REPORT_v5Q0_IHME.dta" 	# Palau 1995 Census report SBH
  bdi.priority.survey1998.sbh <- "EST_BDI_PRIORITY_SURVEY_1998-1999_v5Q0_IHME.dta" #Burundi Priority Survey 1998-1999 SBH
  mdv.vpa1998.sbh <- "EST_MDV_VPA_REPORT_1998_v5Q0_IHME.dta" 	# Maldives Vulnerability and Poverty Assessment 1997-1998 SBH
  ...
  pak.cps1993.sbh <- "EST_PAK_CPS_1993_report_v5Q0_IHME.dta"	# Pakistan 1993 Contraceptive Prevalence Survey SBH
  ...
  bdi.ds1970.sbh <- "EST_BDI_DS_1970-1971_v5Q0_IHME.dta"		# Burundi Demographic survey report, tm data replacement
...
#Complete birth history datasets
  ...
  tlsdhs.direct<-"EST_TLS_DHS_v5Q0_IHME_BY_SURVEY.dta"				       		      ## subset of IDN DHS for Timor Leste back in time (unpooled 9/22/2014)
  ...
  ind.dhs.urban.rural.direct <- "EST_IND_DHS_urban_rural_v5Q0_IHME_BY_SURVEY.dta" ## IND urban rural direct cbh un-pooled 9/22/2014
  ...
  bwa.fhs.2007.2008.direct <- "EST_BWA_FHS_2007_2008_v5Q0_IHME_22125.dta" #too low, will need to be outliered
...
#Aggregate q5 estimate datasets
  ...
  irn.agg<-"EST_IRN_1965-2000_v5Q0_.dta"                # IRAN: ASSORTED DATA FROM 
  ...
  pngdhs.agg<-"EST_PNG_DHS_PRELIM_REPORT_2006_v5Q0.dta"             # PNG: DHS 1996 PRELIMINARY REPORT FROM ALAN
  ...
  dhsfinal.agg<-"EST_DHS_FINAL_REPORT_v5Q0.dta"                     # DHS Final Reports (doesn't mean the data has been released)
  ...
  transmonee.agg<-"EST_TransMONEE_EUR_1989-2012_v5Q0.dta"			      # 5q0 estimates from the TransMONEE database (updated july 2015 to include 2008-2012)
  chnsur2011.agg<- "EST_CHN_MCHSS_1996-2013_5q0.dta"                # 5q0 from National Maternal and Child Health Surveillance System 00-10
  srsbgd.agg<- "EST_BGD_SRS_REPORT_v5Q0.dta"							          # 5q0 estimates from the Bangladesh SRS reports
  ...
  mics4.agg <- "EST_COG_GNB_MICS4_2010_REPORT_v5Q0.dta"             # GNB preliminary report from MICS4   (COD now has microdata)
  ...
  irn.midhs2010.from.agg <- "EST_IRN_2010_MIDHS.DTA"                # IRN: MIDHS 2010 5q0 estimates
  ...
  vnm.hsy.08.agg <- "EST_VNM_HSY_2008_5q0.dta"                      # VNM Health Statistics Yearbook 2008 - single data point
  ...
  mng.rhs.1998.report.agg <- "MNG_RHS_1998_REPORT.dta"     # MNG RHS 1998 report (CBH)
  sdn.papfam.2006.report.agg <- "SDN_PAPFAM_2006_REPORT.dta"   # SDN PAPFAM 2006 (Household Health Survey)
  ...
  ind.dhs.2015.agg <- "EST_IND_DHS_2015-2016_v5Q0.dta"	# India subnational DHS 2015-2016 direct aggregate estimates
  bgd.srs.2012_2014.agg <- "EST_BGD_SRS_2012-2014_v5Q0.dta"	# Bangladesh SRS 2012-2014 report direct aggregate estimates
...
#Update VR
  ...
  births.file <- "/births_gbd2015.dta" 
  ind.srs.births.file <- "/IND_SRS_births_Back_calculated.csv"
  ind.srs.births.urb.rur <- "SRS_urban_rural_births_for_combineallchild.csv"
...
# ----------------------------------------------------------------------------
# 00. Add in tm old dataset as framework
# ----------------------------------------------------------------------------

  data<-read.dta(paste(agg.data.dir,tm.data,sep=""), convert.underscore=TRUE)
...
# ----------------------------------------------------------------------------
  ...
  # Remove old data from BGD Retrospective Survey of Fertility and Mortality, 1974 from tm dataset as this new dataset includes the same data, reanalyzed.
  ...
  # The following code eliminates duplicates with tm data or the random sources dataset
  ...
  # Classify the old points (TLS region of IDN) as nonstandard DHS - they underestimate mortality 
  ...
  add.data <- read.dta(paste(sbh.data.dir,dhsindepth.sbh,sep=""), convert.underscore=TRUE)
    # carly 4/4/2014: drop PHL indepth 1993 because we already use the regular 1993 dhs, and this survey asks the same women
...
#  -----------------------------------------------------------------------------
#  Burundi Demographic survey 1970-1971 report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  malawi Population Change survey 1970-1071 report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Papua New Guinea 1971 Census report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Honduras National Demographic Survey report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Cote d'ivoire Demographic Survey 1978-1979 report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Comoros 1980 census report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Bangladesh 1981 Contraceptive Prevalence Survey report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Costa Rica1981 Contraceptive Prevalence Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Jordan 1981 Demographic Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Peru 1981 Contraceptive Prevalence Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Honduras 1983 National Demographic Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Tunisia 1983 Contraceptive Prevalence Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Egypt 1984 Contraceptive Prevalence Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Honduras Nationa Survey of maternal and Child Health SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Pakistan Contraceptive Prevalence Survey 1984-1985 SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  United Arab Emirates Child health Survey 1987-1988 SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Cuba national fertility survey 1987 SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Saudi Arabia Child Health Survey 1987 SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Mauritania 1988 census SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Turkey 1988 Population Health Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Bahrain 1989 Child Health Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Ethiopia National Family and Fertility Survey 1990 SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Maldives 1990 census SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Nepal 1991 National Family Planning and Health SurveySBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  papua New Guinea 1991 DHS SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Sri Lanka 1993 DHS SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  papua New Guinea 1996-1997 SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Iraq Child and maternal mortality survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Jordan 1999 Annual Fertility Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Solomon Islands 1999 Census SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Turkmenistan 2000 DHS SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
#  Lesotho 2001 Demographic Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Mongolia 2003 Reporductive Health Survey SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Gambia 1990 Contraceptive Prevalence SurveySBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Cape Verde Census 2000 report SBH (replacement for tm data)
nrow(data)
...
#  -----------------------------------------------------------------------------
# Honduras 2001 Census report SBH (replacement for tm data)
nrow(data)
...
#-----------------------------------------------------------------------------
# Bangladesh 2011 Census report SBH
nrow(data)
...
# ---------------------------------------------------------------------------- 
  ...
  # Remove World Fertility Survey direct estimates
...
# ----------------------------------------------------------------------------
  ...
  # ----------------------------------------------------------------------------
  # IRAN: ASSORTED DATA FROM 

  add.data<-read.dta(paste(agg.data.dir,irn.agg,sep=""), convert.underscore=TRUE)
  add.data[] = lapply(add.data, function(x) if(is.factor(x)) as.character(x) else x)
  add.data$sd.q5 <- add.data$log10.sd.q5 <- NA
  data = append.data(data, add.data)
  ...
  # ----------------------------------------------------------------------------
  # PNG: DHS 1996 PRELIMINARY REPORT FROM ALAN
  ...
  add.data = read.dta("J:/Project/Mortality/Data search/China/Data from published reports in Chinese/full life table calculation/5q0s_08072009.dta", convert.underscore = TRUE)
  add.data[] = lapply(add.data, function(x) if(is.factor(x)) as.character(x) else x); nrow(add.data)

  add.data = subset(add.data, !(add.data$source %in% add.data$source[grep("(1995 1% population survey)|(2005 1% population survey)|(calculated using 1982 census)" , add.data$source)])); nrow(add.data) # Take out these observations because they are included in the 00. DEATHS file and we don't want to duplicate. JKR 11.23.2009
  ...
  # ----------------------------------------------------------------------------
  # Iran 2010 MIDHS from , tables from report
   nrow(data)
   add.data <- read.dta(paste(agg.data.dir, irn.midhs2010.from.agg, sep=""), convert.underscore = TRUE)
   add.data[] = lapply(add.data, function(x) if(is.factor(x)) as.character(x) else x)
   add.data$sd.q5 <- add.data$log10.sd.q5 <- NA
   data = append.data(data, add.data) 
  ...
  # -----------------------------------------------------------------------------------
  #  Bahrain 1989 Child Health Survey aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Nepal 1991 national family planning and health survey aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Mexico ENADID 1992 aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Sri Lanka 1993 DHS aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Papua New Guinea 1996-1997 DHS aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Iraq child and maternal mortality survey 1999 aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Lebanon 2000 MICS indirect  aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Turkmenistan 2000 DHS aggregate point (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Gambia 1990 Contraceptive Prevalence Survey aggregate points (replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Saudi Arabia levels, trends and differentials of infant and child mortality 1990 indirect aggregate points(replacement for tm data)
  nrow(data)
  ...
  # -----------------------------------------------------------------------------------
  #  Bangladesh SRS 2012-2014 report aggregate points 
  nrow(data)
...
# ------------------------------------------------------------------------------------------
  ...
  # eliminate SRS for the India states from the VR file 
   vr <- vr[!(grepl("IND_", vr$ihme_loc_id) & vr$deaths_source=="SRS"),]

  pop <- read_dta(paste(pop.dir,pop.file,sep=""))
  births <- read.dta(paste(births.dir,births.file,sep=""))
    births <- births[births$sex == "both",c("ihme_loc_id", "year", "births")]
  births.srs <- read.csv(ind.srs.births.file) ## not in thousands (seems small, but is only births in the SRS covered population)
    names(births.srs) <- c("year", "births")
  births.srs <- births.srs[births.srs$year > 1992,]
  
  # temporary fix until all of the input files are changed: replace ihme_loc_id = "CHN" with ihme_loc_id = "CHN_44533"
  ...
  # take out Bangladesh SRS data points - these were missing 0-4 deaths so Jake put in a fake number to avoid having code crash. We need to drop these years so they don't propagate weird 5q0s into the dataset. JKR 11.20.2009
  ...
  ## Add back SSA VR system for south africa
  ...
  for(i in 1:nrow(vrpop)) {
    ...
    if(sum(is.na(mortalityRate[c("0","1")])) == 0) {   
  ...
  add.data = read.dta("nauru2002.dta", convert.underscore = TRUE)
  add.data[] = lapply(add.data, function(x) if(is.factor(x)) as.character(x) else x)
...
local <- rename(local, c("local_id_2013" = "iso3","ihme_loc_id" = "ihme.loc.id"))

## Map iso3's to ihme_loc_id's where ihme_loc_id is NA

## get rid of XIU/XIR data first - they are deprecated
...
##  -------------------------------------------------------------------------
    ...
    # need to delete duplicate - 1990 point from tm dataset
    ...
    # the source below is from tm dataset, the point directly above is for 1992, this is a duplicate with a point estimate in the dataset below
    ...
    # should the line below be the same source?
    ...
    # The year for the 1992 Fertility survey is incorrect
...
# ----------------------------------------------------------------------------
  ...
  # Throw out tm vital registration data
  ...
  # Drop censuses from tm data if there are new data with the same source.date and more than 5 points
  print("dropping censuses from tm data if there are new data with same source.data and more than 5 points (i.e. indirect)")
...
## Eliminate these from the data set. They will not be graphed. Usually they're tm old data that we have new versions of

  scrub <- rep(F, length(data$t)) 
  scrub[data$t < 1400] <- T
  
  # Remove old data from tm dataset that is now entered via statcompiler. 
  ...
  # Remove old source from tm dataset- ambiguous sources 
  ...
  #Remove old data that has been reanalyzed (Scrubbed Dec.2)
  ...
  #'Random SBH' file has Benin Census included twice. Estimates are exactly the same.
  scrub[data$ihme.loc.id == "BEN" & tolower(data$source) == "census february 1992" & data$source.date=="1992" & data$data.age == "new"] <- T  
  
  #1988 'family health survey' 1988 sourcedate from tm is actually a DHS, which has been reanalyzed. Remove both directs and indirects.
  scrub[data$ihme.loc.id == "BWA" & tolower(data$source) == "family health survey" & data$source.date=="1988" & data$data.age == "old"] <- T  
  
  #DZA 1992 enquete nationale sur les objectifs is actually the same as PAPCHILD, which actually moonlights as MICS. Remove from tm dataset. 
  ...
  #ECU 2004 Prelim RHS from tm old-- has been reanalyzed.
  ...
  #ECU 2004 RHS from tm old- directs and indirects have been reanalyzed.
  ...
  #TLS Census 2004- old indirects replaced with new indirect mac onlies booyah. Dropped from tm dataset. 
  scrub[data$ihme.loc.id == "TLS" & tolower(data$source) == "census" & data$source.date=="2004" & data$data.age == "old"] <- T
  
  #1970 RWA Census has been reanalyzed. Remove from tm old dataset.  
  scrub[data$ihme.loc.id == "RWA" & tolower(data$source) == "enquete demographique" & data$source.date=="1970" & data$data.age == "old"] <- T
  
  #1978 RWA Census has been reanalyzed. They are entered twice; once from UNDYB census, and another. Locate original file and remove, scrub for now. 
  ...
  #Remove 1979 encuesta nacional de fecundidad old indirects from tm old. These are actually WFS and have been reanalyzed. 03/23/11 
  ...
  #Remove 1995 OMN Family Health Survey from tm- has been reanalyzed. 
  ...
  #Remove MRT "emip" from tm old- this is actually DHS, and has been reanalyzed (both directs and indirects) 
  scrub[data$ihme.loc.id == "OMN" & tolower(data$source) == "emip" & data$source.date=="2000" & data$data.age == "old"] <- T
  
  #Remove MAR "enquete demographique, 9 may-11 november 1966" there is a duplicate for this in tm dataset (both sources are old). 
  ...
  #Remove BRA 2000 Census (null olds) from tm old dataset. These have been reanalyzed. 
  scrub[data$ihme.loc.id == "BRA" & tolower(data$source) == "census" & data$source.date=="2000" & data$data.age == "old"] <- T
  
  #Remove EGY DHS Directs 2000, 2003 from  tm old dataset. These have been reanalyzed. Misspelling in sourcename is in original file. 
  ...
  #drop points from the old dataset where there is a single estimate from an indirect source--these are all marked as outliers autmatically anyway.
  ...
  scrub[data$ihme.loc.id == "IRN" & tolower(data$source) == "dhs ()"] <- T
  ...
  # We have analyzed Egypt DHS and need to remove old estimates from tm dataset - 12/15/2009
  ...
  scrub[data$ihme.loc.id == "ECU" & tolower(data$source) == "encuesta demografica y de salud familiar" & data$data.age == "old"] <- T # This is the same as DHS 1987. -12/15/09
  ...
  # These have been reanalyzed. CH. 12.17.09 MC
  ...
  # Remove MDA 2005 DHS preliminary report data points. We have analyzed the microdata. 03/30/11 AKLR
  scrub[data$ihme.loc.id == "MDA" & tolower(data$source) == "preliminary dhs" & data$source.date=="2005"] <- T
  
  # scrub old papchild estimates from tm files 
  ...
  # 3/02/10 duplicates sources in china
  ...
  # Get rid of the old PNAD surveys for Brazil 
  ...
  # 4/1/2011 deleting a single direct estimate from tm dataset that seems to represent vr data and is too late to be an accurately classified as a WFS
  scrub[(data$ihme.loc.id == "JAM" & data$source == "contraceptive prevalence survey" & data$source.date == "1989")] <- T
  
  # 5/11/2011 - Drop KHM 2008 Census 
  scrub[data$ihme.loc.id == "KHM" & data$source == "census 2008" & data$in.direct == "hh" & data$source.date == "2008"] <- T 
  
  # 5/20/2011 - Dropping the MOZ CDC-RHS survey (only women 15-24 were asked BH questions)
  ...
  # 6/10/2011 Scrub Ethiopia 2007 HH deaths point 
  scrub[data$source == "Ethiopia 2007 Census" & data$source.date == "2007" & data$in.direct == "hh"] <- T
  
  # 6/14/2011 - Scrub old Gulf Family Health Survey points
  ...
  # 6/30/2011 - India duplicates and problems
  ...
  # 9/26/2011 - duplicate 1985 NIC survey
  scrub[data$ihme.loc.id == "NIC" & data$source.date == "1985" & data$data.age == "old"] <- T
  
  # 9/26/2011 - added a summary birth history for SAU that only had a 1-year recall
  scrub[data$ihme.loc.id == "SAU" & data$source.date == "2006" & data$source == "Population Bulletin 2007"] <- T
  
  # 10/21/2011 - INED points are really from surveys already included in our system - need to exlude points
  scrub[data$source == "INED via Tabutin (1991)"] <- T 
  
  # 11/4/2011 deleting duplicate estimates that have been discovered in the mortality book research process
  ...
  # 2. Probable duplicates of other things from tm dataset
  ...
  scrub[data$ihme.loc.id == "MWI" & data$source == "demographic survey, november-december 1982" & data$data.age == "old"] <- T # this seems to be the same as 'Sample survey, de facto, 1982' from the 'Random' folder 
  ...
  scrub[data$ihme.loc.id == "LKA" & data$source == "DHS Summary of Findings Report" & data$source.date == "1993"] <- T # duplicate of a more complete series in tm dataset
  ...
  #3. MOH  data for CHN, do not have an appropriate populaiton to match with the deaths sample for MOH data
  ...
  ## additional scrubs based on information gathered in compiling citations for the database (01/30/2012)
  ...
  #8/21/2013 - tm point from Tajikistan 2001.9 "Demographic Survey 2002" 
  scrub[data$ihme.loc.id == "TJK" & data$source == "demographic survey 2002" & floor(data$t) == 2001] <- T
  
  # 10/15/2013 : YEM 2007 annual statistical report point, because it is an aggregate estimate from the 2006 MICS3
  scrub[data$ihme.loc.id == "YEM" & data$source == "Yemen Annual Statistical Report" & data$source.date == "2007" & data$t == 2006.5] <- T 

  # 10/15/2013 : YEM dhs statcompiler point because it's a duplicate of the DHS 1997 report that was added
  scrub[data$ihme.loc.id == "YEM" & data$source == "dhs statcompiler" & data$source.date == "1997"] <- T   
  
  # 12/2/2013: drop jordan 1988 epi/cdd and child mortality survey that is "old" data (tm data) 
  ...
  # 12/13/2013: Drop CHN subnat DSP 91-94
  ...
  #2/5/2015: Scrub tm data that were not in CME info - 9 points
  ...
  # 10/29/2015: Scrub tm data that we've replaced with new sources
  ...
  # 10/30/2015: Scrub tm data that we've replaced with new sources  
  ...
  # 11/3/2015: Scrub more tm data that we've replaced with new sources
  ...
  # 11/5/2015: Scrub more tm data that we've replaced with new sources
  ...
  # 11/10/2015: Scrub tm data that we've replaced with new sources  
  ...
  scre <- read.csv("scrub_reintroduce.csv")
...
#########################################################################################
 ...
 #Note that these points are excluded from ALL analysis, but will appear in plots as small gray points.
  ...
  # ADDITIONS FOR OUTLIERS 10 JULY 2009 
  ...
  # ADDITIONS FOR OUTLIERS FROM NEW DYB ESTIMATES  July 13, 2009
  ...
  ### More additions for outliers from DYB estimates July 14, 2009
  ...
  ### Additonal outliers July 18, 2009
  ...
  ## Additional outliers - August 18, 2009
  ...
  ## ZAF oldest ZAF VR estimates are deemed unreliable
  kill[data$ihme.loc.id == "ZAF" & tolower(data$source) == "vr" & data$t <= 1990] <-T 
  
  #Outliers 12/14/07-12/18/09 reviewing book of the dead 3.5 comments 
  kill[data$ihme.loc.id == "LKA" & tolower(data$source) == "vr" & data$t==2005] <- T
  
  #Make IDN 2000 census direct estimates outliers
  kill[data$ihme.loc.id == "IDN" & data$source == "Population Census 2000"] <- T

  # make certian years of egypt vr outliers to match adults
  ...
  # 2/01/10 census data too low
  kill[data$ihme.loc.id == "BMU" & tolower(data$source) == "undyb census"] <- T
  
  # 2/08/10 estimates too low
  kill[data$ihme.loc.id == "SDN" & grepl("PAPCHILD", data$source) & data$in.direct=="hh"] <- T 
  
  # 2/16/10 MICS is high compared to VR for Serbia and there are no other sources
  kill[data$ihme.loc.id == "SRB" & data$source == "MICS3"] <- T 
  kill[data$ihme.loc.id == "KHM" & data$source == "SURVEY" & data$t == 1959] <- T
  
  # 2/24/10 DLHS2  deaths points too low
  kill[data$ihme.loc.id=="IND" & data$source=="DLHS2" & data$in.direct=="hh"] <- T
     
  # 2/25/10 DLHS3 HH Deaths Points too low
  kill[data$ihme.loc.id=="IND" & data$source=="DLHS3" & data$in.direct!="indirect"] <- T
 
  # 2/27/10 HKG census seems to pull down points in backcast
  kill[data$ihme.loc.id == "HKG" & tolower(data$source) == "undyb census"] <- T
 
  # 2/27/10 Past VR point throws off all other VR points because it doesn't line up with VR trend
  kill[data$ihme.loc.id == "PRY" & data$source == "VR" & floor(data$t) == 1950] <- T
 
  # 2/28/10 get rid of tm data looks to be roughly the same as VR. GPR tries to model the VR as biased as well if the 3 old data points are in there
  kill[data$ihme.loc.id == "ARG" & tolower(data$source) == "life tables"] <- T
 
  # 3/01/10 marking three most recent DHS direct points as outliers because they conflict with VR; taking out MICS for similar reasons 
  ...
  # 03/02/10 make 1973 directs outliers. 
  kill[data$ihme.loc.id == "TLS" & data$source=="DHS" & (floor(data$t)== 1974 | floor(data$t) == 1975) & data$in.direct == "direct"] <- T
  
  # 03/02/10 
  # causes implausible dip in 5q0 in lates 60s (these points aren't in the dataset anymore)
  ...
  ## These are indirect estimates from the 15-19 and 20-24 ages groups 
  ...
  # 03/30/2011 marking the Romania LSMS survey as an outlier both indirect and direct points are outliered 
  kill[(data$ihme.loc.id == "ROU" & data$source == "LSMS")] <- T 
  
  # 04/01/2011 marking the Congo AIS survey as an outlier )
  kill[(data$ihme.loc.id == "COG" & data$source == "AIS" & data$source.date == "2009")] <- T
  
  # 04/01/2011 marking the 1990 PHL census as an outlier -- it is consistently below the VR and all of the censuses are inconsistent with the other survey data
  kill[data$ihme.loc.id == "PHL" & data$source == "Census, IPUMS" & data$source.date == 1990 & data$in.direct == "indirect"] <- T
  
  # 04/01/2011 mark the 1998 census estimate (household deaths, presumably) from CIV as an outlier; it is hugely inconsistent with other data
  kill[data$ihme.loc.id == "CIV" & data$source == "CENSUS" & data$source.date == 1998] <- T

  # 04/18/2011 Outliering all CDC RHS in Czech Republic
  ...
  # 05/05/2011 In the paper, census was outliered. Outlier it so it follows VR
  kill[data$ihme.loc.id == "CZE" & data$source == "undyb census"] <- T

  # 04/18/2011 Outliering all UNDYB 1965 Census in Bulgaria 
  kill[data$ihme.loc.id == "BGR" & data$source == "undyb census" & data$in.direct== "indirect, MAC only" & data$source.date==1965] <- T

  # 04/18/2011 Outliering all DHS Special Surveys in MAR. 
  ...
  ## Drop if 5q0 equals 0
  kill[data$q5 == 0 & !data$ihme.loc.id %in% c("AND", "BMU")] <- T
  
  # 4/27/2011 marking the Nigeria MICS SBH data as an outlier - this survey is considerably too low to be a trusted data source
  kill[data$ihme.loc.id == "NGA" & data$source == "MICS3" & data$in.direct == "indirect" & data$source.date == "2007"] <- T
  
  # 4/27/2011 marking the Mozambique AIS SBH data as outliers
  kill[data$ihme.loc.id == "MOZ" & data$source == "AIS" & data$in.direct == "indirect" & data$source.date == "2009"] <- T
  
  # 5/3/2011 marking the China VR data as outliers, the urban rural sampling is biased and causes unreasonably low 5q0 estimates
  kill[data$ihme.loc.id == "CHN_44533" & data$source == "VR_MOH_09C" | data$source == "VR_MOH_10C"] <- T
  
  # 5/4/2011 marking the China censuses as outliers
  ...
  # 5/5/2011 marking the Mauritania MICS as an outlier
  kill[data$ihme.loc.id == "MRT" & data$source == "MICS3"] <- T

  # 5/11/2011 Outlier Guatemala RHS 1978 - this survey falls below the VR data 
  kill[data$ihme.loc.id == "GTM" & data$source == "CDC-RHS" & data$source.date == "1978"] <- T
  
  # 5/11/2011 Outlier TLS 1997 DHS indirects 
  kill[data$ihme.loc.id == "TLS" & data$source == "DHS" & data$in.direct == "indirect" & data$source.date == "1997"] <- T
  
  # 5/12/2011 Outlier CHN 1 per 1000 Sample Survey on Pop Change for 2003, estimate is below moh data
  kill[data$ihme.loc.id == "CHN_44533" & data$source == "1 per 1000 Survey on Pop Change" & data$source.date == "2003"] <- T

  # 5/20/2011 - Outlier the Nigeria WFS MAC only (this survey is much too low for the time period - mid 60's to 1980)
  kill[data$ihme.loc.id == "NGA" & data$source == "world fertility survey" & data$in.direct == "indirect" & data$source.date == "1981"] <- T 
  
  # 5/20/2011 - Outlier the 2001 Nepal Census - the estimates are too low 
  ...
  # 5/20/2011 - Outlier the 1973 Pakistan Census - the estimates are too low 
  ...
  # 5/20/2011 - Outlier the 1993 and 2007 Peru Censuses - the estimates are too low
  kill[data$ihme.loc.id == "PER" & data$source == "Census, IPUMS" & data$in.direct == "indirect" & (data$source.date == "1993" | data$source.date == "2007")] <- T
  
  # 5/20/2011 - Outlier the 1980, 1990, and the 2000 Thailand Censuses, they are all too low (leaving the 1970 census in, this census has a consistent trend)
  ...
  # 6/16/2012 Outlier PAK early SRS -- low estimates, drive the estimated completeness of the SRS system as a whole
  kill[data$ihme.loc.id == "PAK" & data$source == "SRS" & data$t <= 1980] <- T
  
  # 6/17/2012 - Outlier MUS VR in the early years that is unreasonable low
  kill[data$ihme.loc.id == "MUS" & data$t <= 1956 & data$q5 <= 10] <- T
  
  # 6/18/2012 - Outliers 
  kill[data$ihme.loc.id == "OMN" & data$t <= 2004 & data$source == "VR"] <- T                            # these point are before the VR system was reliable 
  kill[data$ihme.loc.id == "PAN" & data$source == "Census, IPUMS" & data$source.date == "1980"] <- T     # too low
  kill[data$ihme.loc.id == "PAN" & data$source == "undyb censys" & data$source.date == "1981"] <- T      # too low
  
  # 6/21/2012 - Outliers based on VR completeness issues
  ...
  # 6/28/2012 - Outlier the GTM VR point that dips unreasonably low, dragging down the GPR trend 
  kill[data$ihme.loc.id == "GTM" & data$source.date=="1981" & data$source == "VR"] <- T
  
  # 8/13/2012  - Outlier most recent CBH estimates from the Liberia MIS (too low)
...
##########################
  ...
  #Kill hh points - brought in in VR process 
  ...
  ##Kill almost all other hh points
    ...
    #These are old tm points; most are censuses; some others
	...
	# Exception for Eastern Cape (ZAF_482) keep in the 2000 and 2006 census (9/2015)
  ...
  #Implausible bumb in SRB SBH-take out whole series
  kill[data$ihme.loc.id == "SRB" & data$source == "MICS3"] <- T
  ...
  #New Thailand VR points unreliable - come from DYB that includes past years' deaths?
  kill[data$ihme.loc.id == "THA" & data$source == "VR" & (data$t > 2007 & data$t < 2009)] <- T
  ...
  #South Africa DHS 2003, "has well-discussed data quality concerns"
  kill[data$ihme.loc.id == "ZAF" & data$source == "DHS final report"] <- T
  
  #Oman VR (two points) that is actually MOH hospital deaths
  kill[data$ihme.loc.id == "OMN" & data$source == "VR" & (data$t %in% c(2001, 2003))] <- T

  # 11/11/2013 (MMC) - Outlier Hainan 1982 census point because we have deaths and not pop so it's using the wrong pop
  kill[data$ihme.loc.id == "CHN_499" & data$source == "CENSUS" & data$t == 1982] <- T

  #First hh point in PRK (north korea) - outlier to get higher 5q0 (closer to stage 1) and closer to gbd2010
  kill[data$ihme.loc.id == "PRK" & data$t < 2000] <- T

  # Don't have pop for this (1982) census point so something weird is happening
  ...
  #Cuba - outlier everything but the Census so Cuba VR is complete
  kill[data$ihme.loc.id == "CUB" & !(data$source %in% c("VR", "undyb census"))] <- T

  #Madagascar - outlier most recent two MIS (2011, 2013) as they cause an unrealistic upward trend after 2010
  kill[data$ihme.loc.id == "MDG" & data$source == "MIS" & (data$source.date %in% c("2011","2013"))] <- T
  ...
  # outlier CRI 2011 census - makes vr complete, and we want vr incomplete
  kill[data$ihme.loc.id == "CRI" & data$source == "133760#CRI_CENSUS_2011" & data$t < 2010 & data$t > 1990] <- T
  
  # outlier ZAF 2011 household point - makes vr more complete, and we want a big hiv bump 3/3/14
  kill[data$ihme.loc.id == "ZAF" & data$source == "CENSUS" & data$t ==2011] <- T

  #outlier some other ZAF stuff to try and make vr correction better (higher in early 2000s)
  ...
  kill[data$ihme.loc.id == "BWA" & data$source == "FHS 2007" & data$in.direct == "direct"] <- T
  ...
  #Outlier most recent Russia VR point (2012?)
  kill[data$ihme.loc.id == "RUS" & data$source == "VR" & data$t == 2012] <- T
  ...
  # Outlier the  CBH from the 2013 MIS in MDG because all of the estimates are at 0 (5/14/2015)
  kill[data$ihme.loc.id == "MDG" & data$source == "MIS 2013" & data$in.direct == "direct"] <- T
  ...
  # Outlier the  CBH from the 2007 LSMS in TJK because all of the estimates are almost at 0 (too low) (5/18/2015)
  kill[data$ihme.loc.id == "TJK" & data$source == "LSMS 2007" & data$in.direct == "direct"] <- T
  
  # Outlier the  last VR point in Uruguay (2010) because the estimates are too high (5/18/2015)
  ...
  # Outlier really low nigeria VR point in 2007 (6.24.2015)
  ...
  # outlier the Comoros 2012-2013 DHS
  kill[data$ihme.loc.id == "COM" & (data$source == "DHS 2012-2013" | (data$source == "DHS" & data$source.date == 2012))] <- T  
  ...
  # for now, outlier DOM points that are being crazily adjusted
  ...
  kill[data$ihme.loc.id=="BLR" & data$t %in% c(2012,2013,2014)] <- T
...
## Mortality shocks  
  ...
  # need to include a CHN indirect point that has bee outliered (1992.6 1% Intra-Census Survey with a sourcedate of 1995
  ...
  data$source[data$source == "tm vr"] <- rep("tm vital registration",sum(data$source == "tm vr"))
  ...
  ### Get rid of any of tm old data #####
  data <- data[data$data.age=="new",]


  old <- read.table("raw.5q0.unadjusted.txt", header=T)
  write.table(data, "raw.5q0.unadjusted.txt", sep = "\t", col.names = TRUE, row.names = FALSE)
  write.table(data, paste("raw.5q0.unadjusted - ", format(Sys.time(), format = "%m-%d-%y"), ".txt", sep = ""), sep = "\t", col.names = TRUE, row.names = FALSE)
 ...
 #########
  ...
  data <- read.table(file="raw.5q0.unadjusted.txt", sep="\t",header=TRUE)
  pdf(paste("", Sys.Date(), ".pdf", sep=""), onefile=T, width=9, height=6)
  count <- 0 
  ...
  for(location in sort(unique(data$location))) {
    count <- count + 1 
     ...
     flush.console()
    Graph5q0new(data[data$location == location,], graph.compare=F, justdata=T, xrange=c(1950,2013))
  }
  dev.off()  
