...
// LOAD SETTINGS FROM MASTER CODE (NO NEED TO EDIT THIS SECTION)
	...
	** specify which sequelae to upload to epi_viz	(upload: 1; do not upload: 0)
		...
		local upload_long_modsev 	0	/* long term sequelae with mortality risk */
		local upload_cases 			0	/* short term sequela due to bacterial infection */
		local upload_viral 			0	/* short term sequela due to viral infection */
	** ****************************************************************************
