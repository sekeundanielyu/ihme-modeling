...
// Filepaths
local GBD_pop "strPath/population_gbd2015.dta"
local HIV_free_mort "strPath/compiled_lt_mx_mean.dta" 

local extract_dir "strPath"
local figure_dir "strPath"
local regress_dir "strPath"
...
**************************************************************
use `GBD_pop' if year >= 1970 & sex != "both", clear
...
**************************************************************
drop _m pop_0 pop_1_4 pop_5_9 mx_nohiv_mean0-mx_nohiv_mean5 mx_nohiv_mean85-mx_nohiv_mean110 pop_80_ pop_85_89 pop_90_94 pop_95_99 pop_100_
order id iso3
...
// Some population numbers are missing for 85+ granular age groups in lower income countries.  We'll set missings to zeroes here, as all we're doing is computing weighted averages so it won't affect the final results.  We'll also set the corresponding mortality rates to zero.
...
// Wider age interval than life-table5-year rates
...
if `visuals' == 1 {
	preserve
		...
		graph export "`figure_dir'/hiv_specific_mortality_vs_all_cause_noart.png", replace
