...
// Prep pooled ALPHA network data, UNAIDS Weibull, and ZAF Miners cohort from so baseline mortality can be subtracted to achieve HIV relative mortality
...
// Filepaths
local alpha_path "strPath/EA_data_thief_prep.csv"
local zaf_path "strPath/SA_data_thief_prep.csv"

local extract_dir "strPath"
local raw_dir "`extract_dir'/no_art/raw"
local out_dir "`extract_dir'/no_art/compiled"
