...
// Save compartmental model mortality and progression parameters as inputs for SPECTRUM 
...
// Filepaths
local comp_dir "strPath"
local graph_dir "strPath"
local progression_path "strPath"
local mortality_path "strPath"
...
bysort draw: egen drop_draw = total(no_converge)
replace par = . if drop_draw > 0

drop no_converge drop_draw
