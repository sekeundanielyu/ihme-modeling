...
// Set Settings
	...
	local gbd2013_dir "strPath"
	local gbd2015_dir "strPath"
...
// Bring in GBD 2015 HR data
	cd "`gbd2015_dir'"
	import excel using "lit_extraction_hiv_onART_brownav_Y2015M06D08.xlsx", firstrow clear sheet("Hazard Ratio")
	tostring subcohort_id, replace
	gen gbd = 2015
	tempfile hr_2015
	save `hr_2015'

	import excel using "", firstrow clear sheet("Hazard Ratio") cellrange(A1:AQ72)
	tostring subcohort_id, replace
	tempfile art_hr
	save `art_hr'
	use `hr_2015', clear
...
// Bring in GBD2015 KM data
	import excel using "lit_extraction_hiv_onART_brownav_Y2015M06D08.xlsx", firstrow clear sheet("Kaplan-Meier") cellrange(A1:AY242)
	tostring subcohort_id, replace
	gen gbd = 2015
	tempfile km_2015
	save `km_2015'
...
// Format and output data into formatted datasheet
	...
	cd "`out_dir'"
	/* import excel using "HIV_extract_HR_2015.xlsx", firstrow clear
	describe, varlist
	...
	import excel using "HIV_extract_KM_2015.xlsx", firstrow clear
	describe, varlist
	...
	*/
	...
	import excel using J:\WORK\04_epi\01_database\02_data\hiv\archive_2013\01_lit\02_download\extraction\AR\ltfu_mortality_studies.xlsx, firstrow clear
	...
	append using `old_sourcing'
	outsheet using J:\WORK\04_epi\01_database\02_data\hiv\extraction_2015\gbd2013_sources.csv, comma replace
	*/
