###########################################################
### Project: ubCov
### Purpose: Register data for upload
###
###	Processes: 
###		- Takes in .csv/.dta of raw data with required columns
###		- Checks data
###			- Column names against a template
###		- Registers against central_data_db.csv
###		- Saves an .R5 of the data
###
###########################################################
...
register_data <- function(me_name, path, user_id, notes, is_best=0, bypass=FALSE) {
	...
	## Data Checks
		...
		## Check that me_name in the dataset is filed and consistent with me_name
