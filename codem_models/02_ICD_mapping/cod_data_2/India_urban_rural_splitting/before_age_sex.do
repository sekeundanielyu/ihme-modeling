	...
	if "${data_name}"=="India_CRS" {
		...
		** "Diarrhea- drop all CRS for cases below"
		...
		foreach var of varlist deaths7-deaths25 {
			** Females, Andhra Pradesh rural 1983-1995 (age groups 5-9 and above)
			replace `var' = . if acause=="diarrhea" & location_id==43908 & year>=1983 & year<=1995 & sex==2
			** Males/females, Arunachal Pradesh rural 1986-1995 (age groups 5-9 and above)
		...
		** Males/females, Andhra Pradesh rural 1988-1995
		drop if acause=="lri" & location_id==43908 & year>=1988 & year<=1995
		** Females, Arunachal Pradesh rural 1986-1994
		...
		** Males/females, Tamil Nadu urban and rural 1992, 1993, 1995
		...
		local drop_states `" "Goa" "Gujarat" "Haryana" "Himachal Pradesh" "Karnataka" "Kerala" "Madhya Pradesh" "Maharashtra" "Manipur" "Mizoram" "Orissa" "Punjab" "Rajasthan" "Tamil Nadu" "The Six Minor Territories" "'
