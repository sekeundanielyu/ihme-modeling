...
** COUNTRY IDENTIFIERS (location_id, iso3, subdiv) **
	** location_id (numeric) if it is a supported subnational site located in this directory
	...
	replace location_id=43872 if subdiv=="Andhra Pradesh"
	replace location_id=43873 if subdiv=="Arunachal Pradesh"
	...
	replace location_id=43884 if subdiv=="Himachal Pradesh"
	...
	replace location_id=43890 if subdiv=="Madhya Pradesh"
	...
	replace location_id=43904 if subdiv=="Uttar Pradesh"
