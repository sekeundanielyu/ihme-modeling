** Purpose: Create Telangana observations out of SCD & MCCD data, pulling some of the Andhra Pradesh sample size into Telangana

local source = source in 1
assert inlist("`source'", "India_SCD_states_rural", "India_MCCD_states_ICD9", "India_MCCD_states_ICD10")

** set id for Andhra pradesh
...
** save andhra pradesh data in original
di "`ap_id'"
di "`tg_id'"
...
** call andhra pradesh telangana and append together; now cause fractions have been copied and we need to split the sample_size
...
** use the old data, drop the andhra pradesh, add in the ap+tg data
use `data'
